    ...
    try {
        ...
        for (let account of accounts) {
            html +=
                ...
                <a href="withdraw.html?id=${account.id}" class="btn btn-primary btn-sm">Withdraw</a>
                <a href="deposit.html?id=${account.id}" class="btn btn-primary btn-sm">Deposit</a>
                <a href="transactions.html?id=${account.id}" class="btn btn-primary btn-sm">Transactions</a>
                </div>
                </div>`;
        }
